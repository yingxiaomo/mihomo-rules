...
# 官方源码URL（备用）: https://raw.githubusercontent.com/vernesong/mihomo/Alpha/component/smart/lightgbm/transform.go
GO_REMOTE_URL = "https://raw.githubusercontent.com/yingxiaomo/mmihos/alpha-merged-smart-xhttp/component/smart/lightgbm/transform.go"  # 我的仓库（Smart 魔改所在分支）
